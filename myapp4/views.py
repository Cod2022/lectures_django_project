...
# Используем вместо класса ManyFieldsForm класс с виджетами ManyFieldsFormWidget
def many_fields_form(request): 
    if request.method == 'POST': 
...
def upload_image(request): 
    if request.method == 'POST': 
        ...
        if form.is_valid(): 
            ...
            fs = FileSystemStorage() # экземпляр класса FileSystemStorage, позволяющий работать с файлами
