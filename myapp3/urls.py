...
urlpatterns = [ 
    path('hello/', hello, name='hello'), # пишем функцию без скобок
    path('hello2/', HelloView.as_view(), name='hello2'), # пишем класс и метод класса со скобками (отличие от представления через функции)
    ...
    path('post/<int:post_id>', post_full, name='post_full'), # передаём имя 'post_full' в шаблон
    ]